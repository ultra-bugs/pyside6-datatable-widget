...
class Ui_DataTable(object):
    def setupUi(self, DataTable):
        ...
        DataTable.setStyleSheet('QPushButton:hover {\n    background-color: #3e3e42;\n}\n\nQPushButton:pressed {\n    background-color: #007acc;\n}')
        ...
        self.morePageBtn.setObjectName('morePageBtn')
    ...
    def retranslateUi(self, DataTable):
        DataTable.setWindowTitle(QCoreApplication.translate('DataTable', 'DataTable', None))
        ...
        self.rowsPerPageCombo.setToolTip(QCoreApplication.translate('DataTable', 'Items per page', None))
        ...
        self.displayingEntriesLbl.setText(QCoreApplication.translate('DataTable', '1 - 10', None))
        self.slashEntriesLbl.setText(QCoreApplication.translate('DataTable', '/', None))
        self.totalEntriesLbl.setText(QCoreApplication.translate('DataTable', '50', None))
        ...
        self.morePageBtn.setText(QCoreApplication.translate('DataTable', '...', None))
